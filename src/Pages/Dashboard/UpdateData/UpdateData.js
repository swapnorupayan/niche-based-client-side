...
const UpdateData = () => {
    ...
    useEffect(() => {
        const url = `https://limitless-forest-07232.herokuapp.com/products/${serviceId}`;
        fetch(url)
            .then(res => res.json())
        ...
        <>
            ...
            <div className="addservice">
                ...
                <form onSubmit={handleUpdateuser}>
                    ...
                    <input onChange={handleNamechange} type="text" value={service.name || ''} placeholder="Enter your car name" />
                    <input onChange={handlePricechange} type="number" value={service.price || ''} placeholder=" Price" />
                    <input onChange={handlePackagechange} type="text" value={service.packege || ''} placeholder="Budget" />
